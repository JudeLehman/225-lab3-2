pipeline {
    ...
    environment {
        DOCKER_CREDENTIALS_ID = 'lehmanjb-dockerhub'
        DOCKER_IMAGE = 'cithit/lehmanjb'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/JudeLehman/225-lab3-2.git'                   // <------change this
        KUBECONFIG = credentials('lehmanjb-225')                                             // <------change this
    }
